                                              ...
                                              <div class="row">
                                                  <div class="col-md-6">
                                                      <div class="mb-3">
                                                          ...
                                                          <input class="form-control input-air-primary" id="names_c" name="names_c" type="text" placeholder="Ejem. Nombre de Cliente" autofocus>
                                                          <input class="form-control input-air-primary" id="id_category" name="id_category" type="hidden" placeholder="Ejem. Nombre de Cliente" autofocus>
                                                      </div>
                                                  </div>
                                                  <div class="col-md-6">
                                                      <div class="mb-3">
